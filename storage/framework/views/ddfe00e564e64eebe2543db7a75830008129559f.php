...
if (isset($message)) { $messageCache = $message; }
$message = $errors->first('institution'); ?>
                                    <span class="invalid-feedback" role="alert">
                                        <strong><?php echo e($message); ?></strong>
                                    </span>
                                <?php unset($message);
...
<?php echo $__env->make('layouts.app', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH D:\Better version\xampp\htdocs\KA2006\Ka20006-Laravel\resources\views/auth/register.blade.php ENDPATH**/ ?>